...
public class ExtraMemberApplication {
	...
	public static void main(String[] args) {
		...
		GossipClusterMember member = new GossipClusterMember("Laptop", "192.168.0.103", 9000, System.currentTimeMillis(),"");
		GossipCluster cluster = new GossipCluster(CLUSTER, "Computer", "192.168.0.104", 9000, member );
